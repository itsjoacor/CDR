  ...
  const modules = [
    {
      ...
      color: 'bg-blue-50 hover:bg-blue-100 border-blue-200 dark:bg-blue-950/30 dark:hover:bg-blue-900/40 dark:border-blue-800',
    ...
    },
    {
      ...
      color: 'bg-purple-50 hover:bg-purple-100 border-purple-200 dark:bg-purple-950/30 dark:hover:bg-purple-900/40 dark:border-purple-800',
      canEdit: user?.role === 'admin',
    },
    {
      path: '/producto',
      ...
      color: 'bg-orange-50 hover:bg-orange-100 border-orange-200 dark:bg-orange-950/30 dark:hover:bg-orange-900/40 dark:border-orange-800',
      canEdit: user?.role === 'admin',
    },
    {
      path: '/mano-obra',
    ...
    },
    {
      ...
      color: 'bg-yellow-50 hover:bg-yellow-100 border-yellow-200 dark:bg-yellow-950/30 dark:hover:bg-yellow-900/40 dark:border-yellow-800',
      canEdit: user?.role === 'admin',
    },
    {
      path: '/resultados-cdr',
      ...
      color: 'bg-green-50 hover:bg-green-100 border-green-200 dark:bg-green-950/30 dark:hover:bg-green-900/40 dark:border-green-800',
      canEdit: false,
    },
  ];
